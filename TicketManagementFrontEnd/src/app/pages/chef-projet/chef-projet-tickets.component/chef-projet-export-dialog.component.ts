...
@Component({
  selector: 'app-chef-projet-export-dialog',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
...
export class ChefProjetExportDialogComponent implements OnInit {
  selectedFilterType: 'project' | 'status' | 'priority' | 'all' = 'all';
  selectedProjectId: number | null = null;
  selectedStatus: string | null = null;
  selectedPriority: string | null = null;

  constructor(
    public dialogRef: MatDialogRef<ChefProjetExportDialogComponent>,
